...
function construct_output(comment, name) {
    ...
    var output = '<div id="' + name + DATE.getTime() + '">' + comment_output + "<br>" + '<button class="answer_button" onclick="display_answer_block(this)"><span>Antworten</span></button>' + ANSWER_FIELD + '</div>';
    return output;
}
